...
RSpec.describe "verify_text" do 
  ...
  it "should return true if first letter is capitalized and there is ponctuation mark" do
    expect(verify_text("Good morning!")).to eq true
  end

  it "should return false if first letter is capitalized and there is no ponctuation mark" do
